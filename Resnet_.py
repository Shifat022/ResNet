...
# Transforms (uncomment normalization if needed)
...
train_data = datasets.ImageFolder(root=path + 'train_data/', transform=transform)
test_data = datasets.ImageFolder(root=path + 'test_data/', transform=transform)
